...
describe("Entity API", () => {
    ...
    afterAll(async () => {
        ...
        for (const entityId of createdEntityIds) {
            try {
                console.log(
                    `Created entity ${entityId} - cleanup may be manual`,
                );
            } catch (error) {
    ...
    test("should create an entity with minimal required fields", async () => {
        ...
        expect(response.email).toBe(
            `minimal-entity-${randomSuffix}@example.com`,
        );
    ...
    test("should update an entity", async () => {
        ...
        expect(response.email).toBe(
            `updated-entity-${randomSuffix}@example.com`,
        );
    ...
    test("should update entity with partial data", async () => {
        ...
        expect(response.email).toBe(
            `partially-updated-${randomSuffix}@example.com`,
        ); // Should be updated
    });
